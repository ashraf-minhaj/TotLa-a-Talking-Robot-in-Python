"""
Making of a talking robot v2 with wake up word.
...
"""
#Wake the robot up by saying it's name 'Totla'
#If you don't call it up by name it won't listen and wont talk back
"""
Basic flow: 
